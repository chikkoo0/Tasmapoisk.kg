"""
Django settings for tasmapoisk project.
...
SECRET_KEY = 'django-insecure-&%tsi$n!-*j2$$badc3$tzqwrm**ma$i!87q%@5%qhoxnkqj^t'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'betaholdik@gmail.com'
EMAIL_HOST_PASSWORD = 'siqm skcn htth czje'
